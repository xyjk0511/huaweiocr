...
Imported project-level Codex AGENTS.md from F:\HuaweiOCR\AGENTS.md on 20260702-094227.
The imported AGENTS.md section below is the active project-level Claude instruction unless higher-priority runtime/user instructions override it.
...
# Preserved Previous Project Claude Instructions
